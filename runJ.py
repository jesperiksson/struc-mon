...
# Metadata
        ...
        'sensors' : [10, 45, 90, 135, 170],#[2, 4, 3]
        'speeds' : 20,
...
# LSTM-specific settings
    ...
    early_stopping = True
    # Data
    damaged_element = 90#[10, 45, 68, 90, 112, 135, 170]
    healthy_percentage = 100#[33, 43, 52 , 62, 71, 81, 90, 100]
    ...
    machine_stack = {}
    scoreStacks = {}
    sensor_to_predict_list = [2]
    for i in range(len(sensor_to_predict_list)):
        name = 'J_MLPmodel2'+str(sensor_to_predict_list[i])
        try:
